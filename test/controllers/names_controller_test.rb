...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { description: @name.description, difficulty: @name.difficulty, img: @name.img, location: @name.location } }, as: :json
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { description: @name.description, difficulty: @name.difficulty, img: @name.img, location: @name.location } }, as: :json
    assert_response 200
  end
